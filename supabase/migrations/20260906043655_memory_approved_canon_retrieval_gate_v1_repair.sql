-- Production repair receipt authority: provider migration 20260906043655.
-- Fixes the canonical project display column and enforces approval receipts in every Memory-backed ContextPack branch.
-- P5 VIDEO 4419: require explicit approval receipts for canonical retrieval.
-- Legacy hard-canon rows without approved_by/approved_at remain durable history but are not retrievable authority.
