...
assert(JSON.stringify(executableProgramFiles) === JSON.stringify(["20260901184935_pandora_provider_learning_v1.sql","20260902081500_memory_decision_usefulness_v1.sql","20260902224500_memory_project_review_priority_v1.sql","20260902231500_memory_context_pack_v2.sql","20260902232200_memory_context_pack_v2_repair.sql","20260903040500_memory_projectos_planning_nonce_v1.sql","20260903075000_memory_review_persistence_lineage_idempotency_v1.sql","20260906041000_memory_approved_canon_retrieval_gate_v1.sql"]), `unexpected executable post-baseline migration set: ${executableProgramFiles.join(",")}`);
